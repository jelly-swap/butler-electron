...
exports.default = (swap) => {
    ...
    const { network, outputNetwork, inputAmount, outputAmount, id, receiver, hashLock, transactionHash, expiration, } = swap;
    const sendAmount = math_1.divDecimals(inputAmount, blockchainConfig[network].decimals).toString();
    const receiveAmount = math_1.divDecimals(outputAmount, blockchainConfig[outputNetwork].decimals).toString();
