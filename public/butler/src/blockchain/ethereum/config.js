...
exports.default = () => {
    ...
    const config = Object.assign(Object.assign({}, ethereum_1.Config(7200)), { providerUrl: 'https://mainnet.infura.io/v3/ee13a282868d4e7cb7d9a9543958631d', contractAddress: '0x471B080EffB2bc6fb33c8c6FE6ce1AB46F9f522b', explorer: 'https://etherscan.io/tx/', REFUND_PERIOD: 10, VALID_EXPIRATION: 72000, gasMultiplier: 2 });
    if (address && secret) {
